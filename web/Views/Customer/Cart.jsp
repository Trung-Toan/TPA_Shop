            ...
            <div class="container">
                ...
                <div class="col-md-12 d-flex align-items-center ms-3">
                    <div class="col-md-8 row py-3"> 
                        <div class="text-dark">
                            <c:if test="${requestScope.products.size() == 0 || requestScope.products == null}">
                                <h4 class="text-danger">Let's shopping now</h4>
                                <img src="./images/images.png" alt="emptycart" class="w-75 object-fit-cover"/>
                            </c:if>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 d-flex flex-fill flex-column justify-content-between ">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="box-input" >
                                                        <button class="border-0 bg-white">
                                                            <a href="Cart?Service=minusQuantity&product_id=${product.id}" class="p-3 text-black"><i class="fa-solid fa-minus fs-5"></i></a>
                                                        </button>
                                                        <input type="text" value="${product.quantity}" class="input-number" id="numberValue" />
                                                        <button class="border-0 bg-white">
                                                            <a href="Cart?Service=addQuantity&product_id=${product.id}" class="p-3 text-black"><i class="fa-solid fa-plus fs-5"></i></a>
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="h-50 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="ms-auto">
                                                    <a href="Cart?Service=deleteInCart&product_id=${product.id}" class="text-decoration-none fs-4 fw-bold text-danger">Remove</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-4 col-md-4 text-order fs-4 fw-500 p-5">
                        <div class="w-80 m-auto">
                            ...
                            <a href="Cart?Service=continue" class="mt-5 d-block
